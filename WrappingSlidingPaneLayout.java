...
public class WrappingSlidingPaneLayout extends ViewGroup {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(WrappingSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(WrappingSlidingPaneLayout parent, View child) {
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == WrappingSlidingPaneLayout.this) {
